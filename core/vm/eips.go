...
func opTload(pc *uint64, interpreter *EVMInterpreter, scope *ScopeContext) ([]byte, []byte, error) {
...
func opTstore(pc *uint64, interpreter *EVMInterpreter, scope *ScopeContext) ([]byte, []byte, error) {
...
func opMcopy(pc *uint64, interpreter *EVMInterpreter, scope *ScopeContext) ([]byte, []byte, error) {
	var (
		dst    = scope.Stack.pop()
		src    = scope.Stack.pop()
...
func opBlobHash(pc *uint64, interpreter *EVMInterpreter, scope *ScopeContext) ([]byte, []byte, error) {
...
func opBlobBaseFee(pc *uint64, interpreter *EVMInterpreter, scope *ScopeContext) ([]byte, []byte, error) {
